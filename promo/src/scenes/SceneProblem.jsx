...
export default function SceneProblem({ t, global, variant = 0, rt}) {
  ...
  return (
      ...
      <WallpaperStage clip={variant ? 'i14' : 'raiden'} t={global} offset={variant ? 4 : 1} mode="fill" width="100%" radius={0} />
